			...
			<div class="card-body">
				...
				<div class="fm-menu">
					<div class="list-group list-group-flush"> <a href="javascript:;" class="list-group-item py-1"><i class="bx bx-folder me-2"></i><span>Todos los Archivos</span></a>
						...
						<a href="javascript:;" class="list-group-item py-1"><i class="bx bx-plug me-2"></i><span>Importantes</span></a>
						<a href="javascript:;" class="list-group-item py-1"><i class="bx bx-trash-alt me-2"></i><span>Borrar Archivos</span></a>
						<a href="javascript:;" class="list-group-item py-1"><i class="bx bx-file me-2"></i><span>Documentos</span></a>
						<a href="javascript:;" class="list-group-item py-1"><i class="bx bx-image me-2"></i><span>Imagenes</span></a>
						...
						<a href="javascript:;" class="list-group-item py-1"><i class="bx bx-beer me-2"></i><span>Archivos Zip</span></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="card-body">
				...
				<div class="d-flex align-items-center">
					...
					<div class="flex-grow-1 ms-2">
						...
						<p class="mb-0 text-secondary">9,478 archivos</p>
					</div>
					<h6 class="text-primary mb-0">31.7 GB</h6>
				</div>
				<div class="d-flex align-items-center mt-3">
					...
					<div class="flex-grow-1 ms-2">
						...
						<p class="mb-0 text-secondary">1,234 archivos</p>
					</div>
					<h6 class="text-primary mb-0">20 GB</h6>
				</div>
				<div class="d-flex align-items-center mt-3">
					...
					<div class="flex-grow-1 ms-2">
						...
						<p class="mb-0 text-secondary">200 archivos</p>
					</div>
					<h6 class="text-primary mb-0">34.2 GB</h6>
				</div>
				<div class="d-flex align-items-center mt-3">
